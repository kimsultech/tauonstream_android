...
/**
 * Modified by kimsultan on 23/9/20.
 */
...
public class Socket extends Emitter {
    ...
    public void publish(final String channel, final Object data, final Ack ack) {
        EventThread.exec(new Runnable() {
            public void run() {
                JSONObject publishObject = new JSONObject();
                try {
    ...
    public class Channel {
        ...
        public void publish(String channelName, Object data) {
